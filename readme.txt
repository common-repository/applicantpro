...
ApplicantPro’s plugin provides a simple way to visualize your open positions on your website.
...
To set up the plugin, simply provide your API key from your hiring system, and add the ApplicantPro’s short code to the page you want your job listings on.
...
== Installation ==
1. Upload the plugin files to the `/wp-content/plugins/applicantpro` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the \'Plugins\' screen in WordPress
3. Use the ApplicantPro Name screen to configure the plugin
4. Update the Token, given through your career site.
5. ApplicantPro->settings, update any settings you require
6. Create a new page and add the short_code [applicantpro] to that page
7. Give this new page a Slug name of applicantpro
...
== Changelog ==
1.3.9
Version update, and code cleanup
1.3.8
